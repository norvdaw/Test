...
razryad INT,
id_work INT,
time_all VARCHAR(10) default ('30 ìèí.'),
time_one INT,
...
id_prof INT,
razryad INT,
family VARCHAR(20) default ('Ñâîáîäåí(íà)'),
FIO VARCHAR(20)
)
...
END
go
CREATE PROCEDURE A_proc( -- Количество небракованных деталей, сделанных рабочим
@id_worker int,
...
VALUES
(1,1,3,1,1,'Èâàíîâ È.È.'),
(2,1,2,10,3,'Ïåòðîâ Ï.Ï.'),
(3,2,1,2,4,'Óñìàíîâà Ì.À.'),
(4,3,5,1,1,'Ñèäîðîâà Ó.Ï.');
